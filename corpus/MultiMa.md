...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `multima.py`

## Could not be measured

```
Impossible to load Strategy 'MultiMa'. This class does not exist or contains Python code errors.
```
