...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `multima.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'MultiMa'. This class does not exist or contains Python code errors.
