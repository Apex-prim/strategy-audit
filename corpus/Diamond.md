...
Source: [`davidzr/freqtrade-strategies`](https://github.com/davidzr/freqtrade-strategies) · file `Diamond.py`

## Could not be measured

```
Impossible to load Strategy 'Diamond'. This class does not exist or contains Python code errors.
```
