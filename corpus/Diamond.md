...
Источник: [`davidzr/freqtrade-strategies`](https://github.com/davidzr/freqtrade-strategies) · файл `Diamond.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'Diamond'. This class does not exist or contains Python code errors.
...
| прогрев не объявлен | ⚠ НАЙДЕНО | самый длинный индикатор 18 свечей, startup_candle_count не задан (по умолчанию 0) |
