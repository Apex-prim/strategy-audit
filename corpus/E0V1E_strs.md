...
|---|---|---|
| trades | 14 | 120 |
| average profit per trade % | 1.68 | 1.45 |
| win rate % | 100.0 | 96.7 |
| average trade duration, minutes | 50.0 | 48.0 |
| duration measured in own candles | 10.0 | 9.6 |
...
**Excess over buy-and-hold** (regime-free): author's window **+61.8 pp**, out of sample **-322.6 pp**.
