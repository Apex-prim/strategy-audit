...
Источник: [`davidzr/freqtrade-strategies`](https://github.com/davidzr/freqtrade-strategies) · файл `FastSupertrend.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'FastSupertrend'. This class does not exist or contains Python code errors.
