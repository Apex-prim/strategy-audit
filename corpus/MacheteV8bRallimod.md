...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `MacheteV8bRallimod.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'MacheteV8bRallimod'. This class does not exist or contains Python code errors.
...
| прогрев объявлен | ✅ ПРОШЛА | 500 при потребности 200 |
