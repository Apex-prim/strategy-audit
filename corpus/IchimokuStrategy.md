...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `IchimokuStrategy.py`

## Could not be measured

```
Impossible to load Strategy 'IchimokuStrategy'. This class does not exist or contains Python code errors.
```
