...
|---|---|---|
| trades | 15221 | 14566 |
| average profit per trade % | -0.17 | -0.19 |
| win rate % | 23.5 | 25.5 |
| average trade duration, minutes | 46.0 | 48.0 |
| duration measured in own candles | 9.2 | 9.6 |
...
**Excess over buy-and-hold** (regime-free): author's window **-37.5 pp**, out of sample **-442.9 pp**.
