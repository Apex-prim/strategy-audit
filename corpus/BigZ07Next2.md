...
Источник: [`davidzr/freqtrade-strategies`](https://github.com/davidzr/freqtrade-strategies) · файл `BigZ07Next2.py`
...
|---|---|---|
| сделок | 443 | 1273 |
| ожидание на сделку | -0.32 | 0.41 |
| p-значение средней | 0.08808 | 0.006744 |
| «купил и держи», % | -59.23 | 346.34 |
| итог стратегии, % | -14.27 | 52.61 |
| Шарп | -0.94 | 0.78 |
| Сортино | -0.74 | 0.42 |
| просадка, % | 23.33 | 16.68 |
| фактор прибыли | 0.75 | 1.33 |

**Осталось от ожидания вне выборки: н/п**

⚠ **В окне автора средняя доходность НЕ ЗНАЧИМА** (p = 0.08808 > 0.05). То есть даже in-sample результат неотличим от нуля.

Базовая линия: «купил и держи» на тех же парах дал **-59.23%**, стратегия — **-14.27%**.
