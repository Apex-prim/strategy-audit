...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `MacheteV8bRallimod2.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'MacheteV8bRallimod2'. This class does not exist or contains Python code errors.
...
| прогрев объявлен | ✅ ПРОШЛА | 200 при потребности 60 |
