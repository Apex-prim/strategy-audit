...
Source: [`Foxel05/freqtrade-stuff`](https://github.com/Foxel05/freqtrade-stuff) · file `NotAnotherSMAOffsetStrategyModHO.py`
...
**Excess over buy-and-hold** (regime-free): author's window **+61.0 pp**, out of sample **-296.2 pp**.
