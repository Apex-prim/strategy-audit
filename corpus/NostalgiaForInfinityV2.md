...
|---|---|---|
| trades | 193 | 632 |
| average profit per trade % | 0.38 | 1.64 |
| win rate % | 49.2 | 52.2 |
| average trade duration, minutes | 544.0 | 601.0 |
| duration measured in own candles | 108.8 | 120.2 |
...
**Excess over buy-and-hold** (regime-free): author's window **+67.8 pp**, out of sample **-98.5 pp**.
