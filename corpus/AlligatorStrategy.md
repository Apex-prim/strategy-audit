...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `AlligatorStrategy.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'AlligatorStrategy'. This class does not exist or contains Python code errors.
