...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `JustROCR6.py`
...
| прогрев не объявлен | ⚠ НАЙДЕНО | самый длинный индикатор 499 свечей, startup_candle_count не задан (по умолчанию 0) |
