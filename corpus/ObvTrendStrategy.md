...
Source: [`mlsys-io/PortfolioBench`](https://github.com/mlsys-io/PortfolioBench) · file `ObvTrendStrategy.py`
...
| win rate % | 16.5 | 16.0 |
| average trade duration, minutes | 26.0 | 27.0 |
| duration measured in own candles | 5.2 | 5.4 |
| expectancy per trade (USDT) | -0.07 | -0.07 |
| mean profit p-value | 4.261e-160 | 5.426e-72 |
| market change % (baseline) | -58.52 | 346.34 |
| strategy total % | -96.57 | -96.58 |
| Sharpe | -83.49 | -16.57 |
| Sortino | -128.44 | -28.42 |
| max drawdown % | 96.57 | 96.58 |
| profit factor | 0.4 | 0.45 |
...
| indicator recursion (freqtrade's own `recursive-analysis`) | **found** | индикаторы меняются от объёма истории: obv -93.029%, obv_ema -111.430%, obv_ema_prev -113.823%, rsi 2.684% |
