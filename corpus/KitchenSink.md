...
Source: [`jaredrsommer/freqtradestrategies`](https://github.com/jaredrsommer/freqtradestrategies) · file `KitchenSink (2).py`
...
| прогрев объявлен | clean | 350 при потребности 20 |
