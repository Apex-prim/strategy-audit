...
|---|---|---|
| trades | 4 | 16 |
| average profit per trade % | 0.84 | 0.86 |
| win rate % | 100.0 | 93.8 |
| average trade duration, minutes | 65.0 | 31.0 |
| duration measured in own candles | 13.0 | 6.2 |
...
**Excess over buy-and-hold** (regime-free): author's window **+59.3 pp**, out of sample **-344.6 pp**.
