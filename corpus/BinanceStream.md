...
Source: [`TomtomEh/freqtrade-websocket`](https://github.com/TomtomEh/freqtrade-websocket) · file `BinanceStream.py`

## Could not be measured

```
Impossible to load Strategy 'BinanceStream'. This class does not exist or contains Python code errors.
```
