...
Source: [`jaredrsommer/freqtradestrategies`](https://github.com/jaredrsommer/freqtradestrategies) · file `GKD_FisherTransform (2).py`

## Could not be measured

```
ValueError: Informative dataframe for (BTC/USDT, 6h, spot) is empty. Can't populate informative indicators.
```
