...
| indicator recursion (freqtrade's own `recursive-analysis`) | **found** | индикаторы меняются от объёма истории: ema50 -0.012%, plus_di -0.016%, minus_di 0.031%, DI_values 0.063% |
