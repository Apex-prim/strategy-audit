...
|---|---|---|
| trades | 20 | 161 |
| average profit per trade % | 0.51 | 2.74 |
| win rate % | 75.0 | 82.0 |
| average trade duration, minutes | 152.0 | 119.0 |
| duration measured in own candles | 30.4 | 23.8 |
...
**Excess over buy-and-hold** (regime-free): author's window **+60.3 pp**, out of sample **-275.5 pp**.
