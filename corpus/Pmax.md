...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `Pmax.py`

## Could not be measured

```
TypeError: PMAX() got an unexpected keyword argument 'atrperiod'. Did you mean 'period'?
```
