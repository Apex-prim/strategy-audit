...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `Persia.py`

## Could not be measured

```
Impossible to load Strategy 'Persia'. This class does not exist or contains Python code errors.
```
