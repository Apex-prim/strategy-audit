...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `Persia.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'Persia'. This class does not exist or contains Python code errors.
