...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `BbandRsi.py`
...
| win rate % | 52.7 | — |
| average trade duration, minutes | 152.0 | — |
| duration measured in own candles | 152.0 | — |
| expectancy per trade (USDT) | -0.1 | — |
| mean profit p-value | 5.745e-37 | — |
| market change % (baseline) | -55.54 | — |
| strategy total % | -96.57 | — |
| Sharpe | -32.12 | — |
| Sortino | -27.16 | — |
| max drawdown % | 96.61 | — |
| profit factor | 0.55 | — |
...
**Excess over buy-and-hold** (regime-free): author's window **-41.0 pp**.
