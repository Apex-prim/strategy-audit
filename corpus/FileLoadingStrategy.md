...
Source: [`keithorange/FreqTradeCustomOrders`](https://github.com/keithorange/FreqTradeCustomOrders) · file `file_loading_strategy.py`

## Could not be measured

```
Impossible to load Strategy 'FileLoadingStrategy'. This class does not exist or contains Python code errors.
```
