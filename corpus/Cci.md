...
Source: [`davidzr/freqtrade-strategies`](https://github.com/davidzr/freqtrade-strategies) · file `Cci.py`
...
|---|---|---|
| trades | 9175 | 15656 |
| average profit per trade % | -0.29 | -0.17 |
| win rate % | 42.8 | 45.0 |
| average trade duration, minutes | 70.0 | 72.0 |
| duration measured in own candles | 70.0 | 72.0 |
| expectancy per trade (USDT) | -0.11 | -0.06 |
| mean profit p-value | 2.543e-60 | 5.309e-25 |
| market change % (baseline) | -55.54 | 347.94 |
| strategy total % | -96.61 | -96.59 |
| Sharpe | -41.32 | -10.47 |
| Sortino | -36.82 | -8.72 |
| max drawdown % | 96.63 | 96.6 |
| profit factor | 0.44 | 0.53 |
...
Baseline: buy-and-hold on the same pairs returned **-55.54%**; the strategy returned **-96.61%**.
