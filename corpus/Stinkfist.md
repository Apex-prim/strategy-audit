...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `Stinkfist.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'Stinkfist'. This class does not exist or contains Python code errors.
