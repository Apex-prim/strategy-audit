...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `Stinkfist.py`

## Could not be measured

```
Impossible to load Strategy 'Stinkfist'. This class does not exist or contains Python code errors.
```
