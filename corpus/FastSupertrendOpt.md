...
Источник: [`davidzr/freqtrade-strategies`](https://github.com/davidzr/freqtrade-strategies) · файл `FastSupertrendOpt.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'FastSupertrendOpt'. This class does not exist or contains Python code errors.
