...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `Schism-v2.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'Schism2'. This class does not exist or contains Python code errors.
