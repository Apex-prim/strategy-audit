...
Source: [`markdregan/FreqAI-Marcos-Lopez-De-Prado`](https://github.com/markdregan/FreqAI-Marcos-Lopez-De-Prado) · file `LitmusMetaStrategy.py`

## Could not be measured

```
Impossible to load Strategy 'LitmusMetaStrategy'. This class does not exist or contains Python code errors.
```
...
| прогрев объявлен | clean | 120 при потребности 25 |
