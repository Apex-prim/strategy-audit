...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `CryptoFrogNFI.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'CryptoFrogNFI'. This class does not exist or contains Python code errors.
