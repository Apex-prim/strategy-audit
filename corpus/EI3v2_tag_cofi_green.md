...
Source: [`MMR-19/freqtrade-strategies`](https://github.com/MMR-19/freqtrade-strategies) · file `EI3v2_tag_cofi_green.py`
...
|---|---|---|
| trades | 738 | 2628 |
| average profit per trade % | 0.3 | 0.7 |
| win rate % | 90.5 | 95.0 |
| average trade duration, minutes | 950.0 | 586.0 |
| duration measured in own candles | 190.0 | 117.2 |
...
**Excess over buy-and-hold** (regime-free): author's window **+88.2 pp**, out of sample **+485.2 pp**.
