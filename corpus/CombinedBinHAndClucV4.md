...
|---|---|---|
| trades | 793 | 2172 |
| average profit per trade % | -0.06 | 0.31 |
| win rate % | 59.9 | 69.2 |
| average trade duration, minutes | 214.0 | 155.0 |
| duration measured in own candles | 42.8 | 31.0 |
...
**Excess over buy-and-hold** (regime-free): author's window **+51.7 pp**, out of sample **-227.2 pp**.
