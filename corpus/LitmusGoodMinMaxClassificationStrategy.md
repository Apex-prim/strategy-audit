# LitmusGoodMinMaxClassificationStrategy

Source: [`markdregan/FreqAI-Marcos-Lopez-De-Prado`](https://github.com/markdregan/FreqAI-Marcos-Lopez-De-Prado) · file `LitmusGoodMinMaxClassificationStrategy.py`
...
| прогрев объявлен | clean | 300 при потребности 300 |
