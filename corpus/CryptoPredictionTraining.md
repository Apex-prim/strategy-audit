# CryptoPredictionTraining

Source: [`ShahAnuj2610/my-freqtrade`](https://github.com/ShahAnuj2610/my-freqtrade) · file `CryptoPrediction.py`

## Could not be measured

```
Impossible to load Strategy 'CryptoPredictionTraining'. This class does not exist or contains Python code errors.
```
