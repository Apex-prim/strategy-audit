...
Source: [`TheoBrigitte/freqtrade`](https://github.com/TheoBrigitte/freqtrade) · file `FastSupertrend_ts_origstop_fix.py`

## Could not be measured

```
Impossible to load Strategy 'FastSupertrend_ts_origstop_fix'. This class does not exist or contains Python code errors.
```
