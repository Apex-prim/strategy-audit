...
|---|---|---|
| trades | 123 | 422 |
| average profit per trade % | 0.7 | 1.74 |
| win rate % | 81.3 | 92.4 |
| average trade duration, minutes | 869.0 | 302.0 |
| duration measured in own candles | 173.8 | 60.4 |
...
**Excess over buy-and-hold** (regime-free): author's window **+70.1 pp**, out of sample **-200.3 pp**.
