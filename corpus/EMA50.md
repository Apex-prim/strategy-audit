...
Источник: [`davidzr/freqtrade-strategies`](https://github.com/davidzr/freqtrade-strategies) · файл `EMA50.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'EMA50'. This class does not exist or contains Python code errors.
