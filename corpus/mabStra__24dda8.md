...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `mabStra.py`

## Could not be measured

```
Impossible to load Strategy 'mabStra'. This class does not exist or contains Python code errors.
```
