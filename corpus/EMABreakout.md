...
Источник: [`davidzr/freqtrade-strategies`](https://github.com/davidzr/freqtrade-strategies) · файл `EMABreakout.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'EMABreakout'. This class does not exist or contains Python code errors.
