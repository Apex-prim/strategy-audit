...
Источник: [`davidzr/freqtrade-strategies`](https://github.com/davidzr/freqtrade-strategies) · файл `BBMod1.py`
...
| прогрев занижен | ⚠ НАЙДЕНО | объявлено 120, нужно не менее 200 |
