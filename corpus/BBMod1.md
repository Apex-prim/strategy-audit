...
Source: [`davidzr/freqtrade-strategies`](https://github.com/davidzr/freqtrade-strategies) · file `BBMod1.py`
...
| прогрев занижен | **found** | объявлено 120, нужно не менее 200 |
