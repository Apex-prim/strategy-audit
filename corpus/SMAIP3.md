...
|---|---|---|
| trades | 74 | 290 |
| average profit per trade % | 0.85 | 1.16 |
| win rate % | 86.5 | 78.6 |
| average trade duration, minutes | 590.0 | 629.0 |
| duration measured in own candles | 118.0 | 125.8 |
...
**Excess over buy-and-hold** (regime-free): author's window **+66.3 pp**, out of sample **-295.9 pp**.
