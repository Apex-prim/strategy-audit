...
Источник: [`davidzr/freqtrade-strategies`](https://github.com/davidzr/freqtrade-strategies) · файл `MostOfAll.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'MostOfAll'. This class does not exist or contains Python code errors.
