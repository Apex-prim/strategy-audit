...
Источник: [`nateemma/strategies`](https://github.com/nateemma/strategies) · файл `BaseStrategy.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'BaseStrategy'. This class does not exist or contains Python code errors.
