...
Источник: [`davidzr/freqtrade-strategies`](https://github.com/davidzr/freqtrade-strategies) · файл `ClucHAnix_BB_RPB_MOD2_ROI.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'ClucHAnix_BB_RPB_MOD2_ROI'. This class does not exist or contains Python code errors.
