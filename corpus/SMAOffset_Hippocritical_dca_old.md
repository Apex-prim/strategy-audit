...
Source: [`TheoBrigitte/freqtrade`](https://github.com/TheoBrigitte/freqtrade) · file `SMAOffset_Hippocritical_dca_old.py`
...
| market change % (baseline) | -59.39 | 346.34 |
...
**Excess over buy-and-hold** (regime-free): author's window **+60.7 pp**, out of sample **-336.6 pp**.

Baseline: buy-and-hold on the same pairs returned **-59.39%**; the strategy returned **1.35%**.
