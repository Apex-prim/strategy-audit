# LitmusMinMaxRegretClassificationStrategy

Source: [`markdregan/FreqAI-Marcos-Lopez-De-Prado`](https://github.com/markdregan/FreqAI-Marcos-Lopez-De-Prado) · file `LitmusMinMaxRegretClassificationStrategy.py`

## Could not be measured

```
Impossible to load Strategy 'LitmusMinMaxRegretClassificationStrategy'. This class does not exist or contains Python code errors.
```
