...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `Solipsis_v4.py`

## Could not be measured

```
Impossible to load Strategy 'Solipsis4'. This class does not exist or contains Python code errors.
```
