...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `Solipsis_v4.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'Solipsis4'. This class does not exist or contains Python code errors.
