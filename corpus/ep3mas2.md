...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `ep3mas2.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'ep3mas2'. This class does not exist or contains Python code errors.
