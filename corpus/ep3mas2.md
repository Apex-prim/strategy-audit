...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `ep3mas2.py`

## Could not be measured

```
Impossible to load Strategy 'ep3mas2'. This class does not exist or contains Python code errors.
```
