...
Source: [`jaredrsommer/freqtradestrategies`](https://github.com/jaredrsommer/freqtradestrategies) · file `tsp0chicken.py`

## Could not be measured

```
Impossible to load Strategy 'tsp0chicken'. This class does not exist or contains Python code errors.
```
