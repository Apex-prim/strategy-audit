...
|---|---|---|
| trades | 4526 | 14964 |
| average profit per trade % | -0.17 | -0.18 |
| win rate % | 55.3 | 55.6 |
| average trade duration, minutes | 320.0 | 321.0 |
| duration measured in own candles | 64.0 | 64.2 |
...
**Excess over buy-and-hold** (regime-free): author's window **-4.1 pp**, out of sample **-443.0 pp**.
