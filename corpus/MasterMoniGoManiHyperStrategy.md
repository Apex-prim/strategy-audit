...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `MasterMoniGoManiHyperStrategy.py`

## Could not be measured

```
Impossible to load Strategy 'MasterMoniGoManiHyperStrategy'. This class does not exist or contains Python code errors.
```
