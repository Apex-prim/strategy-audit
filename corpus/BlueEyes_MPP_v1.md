...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `BlueEyes_MPP_v1.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'BlueEyes_MPP_v1'. This class does not exist or contains Python code errors.
...
| прогрев не объявлен | ⚠ НАЙДЕНО | самый длинный индикатор 440 свечей, startup_candle_count не задан (по умолчанию 0) |
