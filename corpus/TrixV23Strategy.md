...
|---|---|---|
| trades | 265 | 1040 |
| average profit per trade % | -0.31 | -0.13 |
| win rate % | 67.5 | 66.5 |
| average trade duration, minutes | 1476.0 | 1322.0 |
| duration measured in own candles | 24.6 | 22.03 |
...
**Excess over buy-and-hold** (regime-free): author's window **+43.8 pp**, out of sample **-365.9 pp**.
