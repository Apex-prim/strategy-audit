...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `SwingHigh.py`
...
| прогрев не объявлен | **found** | самый длинный индикатор 76 свечей, startup_candle_count не задан (по умолчанию 0) |
