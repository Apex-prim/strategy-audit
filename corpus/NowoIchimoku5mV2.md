...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `NowoIchimoku5mV2 (1).py`

## Could not be measured

```
Impossible to load Strategy 'NowoIchimoku5mV2'. This class does not exist or contains Python code errors.
```
