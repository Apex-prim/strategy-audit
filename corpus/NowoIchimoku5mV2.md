...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `NowoIchimoku5mV2 (1).py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'NowoIchimoku5mV2'. This class does not exist or contains Python code errors.
