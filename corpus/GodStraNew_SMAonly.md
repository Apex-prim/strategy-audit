...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `GodStraNew_SMAonly.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'GodStraNew_SMAonly'. This class does not exist or contains Python code errors.
