...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `Heracles.py`

## Could not be measured

```
Impossible to load Strategy 'Heracles'. This class does not exist or contains Python code errors.
```
