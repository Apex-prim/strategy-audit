...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `Heracles.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'Heracles'. This class does not exist or contains Python code errors.
