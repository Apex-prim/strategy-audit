...
|---|---|---|
| trades | 162 | 456 |
| average profit per trade % | 0.3 | 1.37 |
| win rate % | 76.5 | 83.1 |
| average trade duration, minutes | 427.0 | 271.0 |
| duration measured in own candles | 85.4 | 54.2 |
...
**Excess over buy-and-hold** (regime-free): author's window **+65.1 pp**, out of sample **-231.4 pp**.
