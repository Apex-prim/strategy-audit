...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `MacheteV8b.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'MacheteV8b'. This class does not exist or contains Python code errors.
