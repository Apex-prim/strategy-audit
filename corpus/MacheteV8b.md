...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `MacheteV8b.py`

## Could not be measured

```
Impossible to load Strategy 'MacheteV8b'. This class does not exist or contains Python code errors.
```
