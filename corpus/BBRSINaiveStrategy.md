...
|---|---|---|
| trades | 4539 | 15483 |
| average profit per trade % | -0.34 | -0.15 |
| win rate % | 77.1 | 79.4 |
| average trade duration, minutes | 834.0 | 830.0 |
| duration measured in own candles | 55.6 | 55.33 |
...
**Excess over buy-and-hold** (regime-free): author's window **-29.3 pp**, out of sample **-442.7 pp**.
