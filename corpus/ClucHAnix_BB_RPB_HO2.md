...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `ClucHAnix_BB_RPB_HO2.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'ClucHAnix_BB_RPB_HO2'. This class does not exist or contains Python code errors.
