...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `SuperHV27.py`

## Could not be measured

```
Unexpected error KeyError('price_side') calling <bound method SuperHV27.confirm_trade_entry of <SuperHV27.SuperHV27 object at
```
