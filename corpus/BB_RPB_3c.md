...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `BB_RPB_3c.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'BB_RPB_3c'. This class does not exist or contains Python code errors.
