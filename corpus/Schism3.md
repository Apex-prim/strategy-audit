...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `Schism-v1.3.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'Schism3'. This class does not exist or contains Python code errors.
