...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `Dracula.py`

## Could not be measured

```
Impossible to load Strategy 'Dracula'. This class does not exist or contains Python code errors.
```
...
| прогрев не объявлен | **found** | самый длинный индикатор 150 свечей, startup_candle_count не задан (по умолчанию 0) |
