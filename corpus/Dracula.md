...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `Dracula.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'Dracula'. This class does not exist or contains Python code errors.
...
| прогрев не объявлен | ⚠ НАЙДЕНО | самый длинный индикатор 150 свечей, startup_candle_count не задан (по умолчанию 0) |
