...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `DevilStra.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'DevilStra'. This class does not exist or contains Python code errors.
