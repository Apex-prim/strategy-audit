...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `DevilStra.py`

## Could not be measured

```
Impossible to load Strategy 'DevilStra'. This class does not exist or contains Python code errors.
```
