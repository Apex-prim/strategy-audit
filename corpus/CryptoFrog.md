...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `CryptoFrog.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'CryptoFrog'. This class does not exist or contains Python code errors.
