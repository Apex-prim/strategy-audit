...
|---|---|---|
| trades | 456 | 1187 |
| average profit per trade % | -0.78 | -0.82 |
| win rate % | 66.7 | 57.8 |
| average trade duration, minutes | 744.0 | 1062.0 |
| duration measured in own candles | 148.8 | 212.4 |
...
**Excess over buy-and-hold** (regime-free): author's window **+22.4 pp**, out of sample **-417.1 pp**.
