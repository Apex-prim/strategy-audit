...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `CryptoFrogHO3A1.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'CryptoFrogHO3A1'. This class does not exist or contains Python code errors.
