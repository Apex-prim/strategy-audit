...
|---|---|---|
| trades | 208 | 768 |
| average profit per trade % | 0.38 | 1.4 |
| win rate % | 85.6 | 90.8 |
| average trade duration, minutes | 260.0 | 163.0 |
| duration measured in own candles | 52.0 | 32.6 |
...
**Excess over buy-and-hold** (regime-free): author's window **+69.3 pp**, out of sample **-71.3 pp**.
