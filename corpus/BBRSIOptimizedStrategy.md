...
|---|---|---|
| trades | 7183 | 25949 |
| average profit per trade % | -0.25 | -0.09 |
| win rate % | 57.9 | 60.6 |
| average trade duration, minutes | 297.0 | 282.0 |
| duration measured in own candles | 59.4 | 56.4 |
...
**Excess over buy-and-hold** (regime-free): author's window **-31.9 pp**, out of sample **-442.6 pp**.
