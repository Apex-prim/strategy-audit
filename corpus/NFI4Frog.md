...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `NFI4Frog.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'NFI4Frog'. This class does not exist or contains Python code errors.
