...
|---|---|---|
| trades | 2468 | 9880 |
| average profit per trade % | -0.21 | -0.17 |
| win rate % | 48.5 | 50.0 |
| average trade duration, minutes | 511.0 | 501.0 |
| duration measured in own candles | 511.0 | 501.0 |
...
**Excess over buy-and-hold** (regime-free): author's window **+7.5 pp**, out of sample **-436.4 pp**.
