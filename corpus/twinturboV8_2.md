...
|---|---|---|
| trades | 23 | 96 |
| average profit per trade % | -0.03 | 0.81 |
| win rate % | 87.0 | 93.8 |
| average trade duration, minutes | 1005.0 | 650.0 |
| duration measured in own candles | 201.0 | 130.0 |
...
**Excess over buy-and-hold** (regime-free): author's window **+58.1 pp**, out of sample **-336.5 pp**.
