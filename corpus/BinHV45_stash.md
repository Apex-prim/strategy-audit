...
|---|---|---|
| trades | 224 | 1476 |
| average profit per trade % | -0.1 | -0.25 |
| win rate % | 79.0 | 76.6 |
| average trade duration, minutes | 131.0 | 76.0 |
| duration measured in own candles | 131.0 | 76.0 |
...
**Excess over buy-and-hold** (regime-free): author's window **+52.6 pp**, out of sample **-386.1 pp**.
