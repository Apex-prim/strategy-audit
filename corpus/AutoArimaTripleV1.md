...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `AutoArimaTripleV1.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'AutoArimaTripleV1'. This class does not exist or contains Python code errors.
