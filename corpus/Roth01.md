...
|---|---|---|
| trades | 2724 | 9622 |
| average profit per trade % | -0.32 | -0.04 |
| win rate % | 69.5 | 71.1 |
| average trade duration, minutes | 1900.0 | 1958.0 |
| duration measured in own candles | 380.0 | 391.6 |
...
**Excess over buy-and-hold** (regime-free): author's window **-17.3 pp**, out of sample **-423.2 pp**.
