...
Source: [`mlsys-io/PortfolioBench`](https://github.com/mlsys-io/PortfolioBench) · file `HeikinAshiStrategy.py`
...
| win rate % | 19.4 | 17.9 |
| average trade duration, minutes | 25.0 | 24.0 |
| duration measured in own candles | 5.0 | 4.8 |
| expectancy per trade (USDT) | -0.07 | -0.07 |
| mean profit p-value | 1.13e-155 | 1.125e-79 |
| market change % (baseline) | -58.41 | 346.34 |
| strategy total % | -96.57 | -96.57 |
| Sharpe | -80.26 | -17.69 |
| Sortino | -121.97 | -29.98 |
| max drawdown % | 96.57 | 96.57 |
| profit factor | 0.38 | 0.43 |
