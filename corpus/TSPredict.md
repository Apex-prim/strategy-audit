...
Source: [`jaredrsommer/freqtradestrategies`](https://github.com/jaredrsommer/freqtradestrategies) · file `TSPredict.py`

## Could not be measured

```
Impossible to load Strategy 'TSPredict'. This class does not exist or contains Python code errors.
```
