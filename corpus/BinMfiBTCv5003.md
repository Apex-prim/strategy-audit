...
|---|---|---|
| trades | 7 | 164 |
| average profit per trade % | 0.63 | -0.26 |
| win rate % | 71.4 | 38.4 |
| average trade duration, minutes | 44.0 | 26.0 |
| duration measured in own candles | 8.8 | 5.2 |
...
**Excess over buy-and-hold** (regime-free): author's window **+59.4 pp**, out of sample **-351.6 pp**.
