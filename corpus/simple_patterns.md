...
Source: [`TheoBrigitte/freqtrade`](https://github.com/TheoBrigitte/freqtrade) · file `simple_patterns.py`

## Could not be measured

```
Impossible to load Strategy 'simple_patterns'. This class does not exist or contains Python code errors.
```
