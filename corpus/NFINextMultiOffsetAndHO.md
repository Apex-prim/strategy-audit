...
|---|---|---|
| trades | 219 | 875 |
| average profit per trade % | 0.52 | 1.21 |
| win rate % | 70.3 | 81.8 |
| average trade duration, minutes | 222.0 | 158.0 |
| duration measured in own candles | 44.4 | 31.6 |
...
**Excess over buy-and-hold** (regime-free): author's window **+73.9 pp**, out of sample **-81.2 pp**.
