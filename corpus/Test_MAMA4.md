...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `Test_MAMA4.py`

## Результат

**НЕ ПРИМЕНИМА** — ValueError: cannot reindex on an axis with duplicate labels
...
| мёртвые настройки трейлинга | ⚠ НАЙДЕНО | trailing_stop=False, но trailing_stop_positive=0.04 задан — читается как работающая защита |
