...
Source: [`jaredrsommer/freqtradestrategies`](https://github.com/jaredrsommer/freqtradestrategies) · file `battletank.py`

## Could not be measured

```
TypeError: Can't instantiate abstract class thetank2 without an implementation for abstract method 'populate_indicators'
```
