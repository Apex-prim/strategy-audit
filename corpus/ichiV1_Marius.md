...
Источник: [`davidzr/freqtrade-strategies`](https://github.com/davidzr/freqtrade-strategies) · файл `ichiV1_Marius.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'ichiV1_Marius'. This class does not exist or contains Python code errors.
...
| прогрев не объявлен | ⚠ НАЙДЕНО | самый длинный индикатор 1440 свечей, startup_candle_count не задан (по умолчанию 0) |
