...
|---|---|---|
| trades | 1184 | 4736 |
| average profit per trade % | -0.11 | -0.19 |
| win rate % | 41.3 | 38.9 |
| average trade duration, minutes | 270.0 | 309.0 |
| duration measured in own candles | 54.0 | 61.8 |
...
**Excess over buy-and-hold** (regime-free): author's window **+42.8 pp**, out of sample **-413.7 pp**.
