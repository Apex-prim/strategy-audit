...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `StochRSITEMA.py`
...
|---|---|---|
| сделок | 1004 | 3538 |
| ожидание на сделку | -0.23 | -0.2 |
| p-значение средней | 1.51e-10 | 6.446e-49 |
| «купил и держи», % | -58.48 | 346.34 |
| итог стратегии, % | -23.4 | -71.49 |
| Шарп | -5.37 | -7.18 |
| Сортино | -5.27 | -6.88 |
| просадка, % | 23.64 | 71.67 |
| фактор прибыли | 0.48 | 0.37 |

**Осталось от ожидания вне выборки: отрицательное**

Базовая линия: «купил и держи» на тех же парах дал **-58.48%**, стратегия — **-23.4%**.
