...
|---|---|---|
| trades | 111 | 458 |
| average profit per trade % | 0.48 | 1.64 |
| win rate % | 68.5 | 76.6 |
| average trade duration, minutes | 258.0 | 196.0 |
| duration measured in own candles | 51.6 | 39.2 |
...
**Excess over buy-and-hold** (regime-free): author's window **+66.0 pp**, out of sample **-203.0 pp**.
