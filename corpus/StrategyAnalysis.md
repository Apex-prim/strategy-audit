...
Source: [`ShahAnuj2610/my-freqtrade`](https://github.com/ShahAnuj2610/my-freqtrade) · file `StrategyAnalysis.py`

## Could not be measured

```
TypeError: Can't instantiate abstract class StrategyAnalysis without an implementation for abstract method 'populate_indicators'
```
