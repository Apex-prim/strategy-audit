...
Source: [`Foxel05/freqtrade-stuff`](https://github.com/Foxel05/freqtrade-stuff) · file `test.py`
...
|---|---|---|
| trades | 171 | 513 |
| average profit per trade % | 0.37 | 1.18 |
| win rate % | 76.0 | 84.0 |
| average trade duration, minutes | 486.0 | 304.0 |
| duration measured in own candles | 97.2 | 60.8 |
...
**Excess over buy-and-hold** (regime-free): author's window **+67.0 pp**, out of sample **-236.2 pp**.
