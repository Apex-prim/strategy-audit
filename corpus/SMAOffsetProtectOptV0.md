...
|---|---|---|
| trades | 33 | 220 |
| average profit per trade % | 0.34 | 1.16 |
| win rate % | 87.9 | 92.7 |
| average trade duration, minutes | 53.0 | 49.0 |
| duration measured in own candles | 10.6 | 9.8 |
...
**Excess over buy-and-hold** (regime-free): author's window **+59.8 pp**, out of sample **-310.0 pp**.
