...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `BB_RPB_TSL_RNG_TBS.py`
...
|---|---|---|
| trades | 101 | 677 |
| average profit per trade % | 1.11 | 0.98 |
| win rate % | 52.5 | 45.8 |
| average trade duration, minutes | 37.0 | 15.0 |
| duration measured in own candles | 7.4 | 3.0 |
...
**Excess over buy-and-hold** (regime-free): author's window **+73.1 pp**, out of sample **-221.7 pp**.
