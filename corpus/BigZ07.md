...
|---|---|---|
| trades | 409 | 1184 |
| average profit per trade % | -0.38 | 0.4 |
| win rate % | 90.5 | 93.4 |
| average trade duration, minutes | 2297.0 | 1709.0 |
| duration measured in own candles | 459.4 | 341.8 |
...
**Excess over buy-and-hold** (regime-free): author's window **+39.8 pp**, out of sample **-270.1 pp**.
