...
Source: [`TheoBrigitte/freqtrade`](https://github.com/TheoBrigitte/freqtrade) · file `zorkv7_0_0.py`

## Could not be measured

```
ValueError: The number of quantiles cannot be greater than the number of samples used. Got 100000 quantiles and 10000 samples.
```
...
| прогрев не объявлен | **found** | самый длинный индикатор 300 свечей, startup_candle_count не задан (по умолчанию 0) |
