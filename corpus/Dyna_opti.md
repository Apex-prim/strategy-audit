...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `Dyna_opti.py`

## Could not be measured

```
Impossible to load Strategy 'Dyna_opti'. This class does not exist or contains Python code errors.
```
