...
|---|---|---|
| trades | 405 | 1319 |
| average profit per trade % | 0.51 | 0.21 |
| win rate % | 59.0 | 54.6 |
| average trade duration, minutes | 425.0 | 437.0 |
| duration measured in own candles | 85.0 | 87.4 |
...
**Excess over buy-and-hold** (regime-free): author's window **+87.6 pp**, out of sample **-306.0 pp**.
