...
|---|---|---|
| trades | 2552 | 9786 |
| average profit per trade % | -0.28 | -0.23 |
| win rate % | 31.4 | 33.5 |
| average trade duration, minutes | 134.0 | 164.0 |
| duration measured in own candles | 4.47 | 5.47 |
...
**Excess over buy-and-hold** (regime-free): author's window **+0.0 pp**, out of sample **-436.9 pp**.
