...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `ClucHAnix_BB_RPB_MOD_E0V1E_DYNAMIC_TB (1).py`

## Could not be measured

```
Impossible to load Strategy 'ClucHAnix5m'. This class does not exist or contains Python code errors.
```
