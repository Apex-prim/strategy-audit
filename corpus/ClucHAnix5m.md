...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `ClucHAnix_BB_RPB_MOD_E0V1E_DYNAMIC_TB (1).py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'ClucHAnix5m'. This class does not exist or contains Python code errors.
