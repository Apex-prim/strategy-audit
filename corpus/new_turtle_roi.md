...
Source: [`TheoBrigitte/freqtrade`](https://github.com/TheoBrigitte/freqtrade) · file `new_turtle_roi.py`

## Could not be measured

```
Impossible to load Strategy 'new_turtle_roi'. This class does not exist or contains Python code errors.
```
