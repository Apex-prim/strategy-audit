...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `Obelisk_3EMA_StochRSI_ATR.py`
...
| прогрев объявлен | clean | 500 при потребности 50 |
