# AdaptiveRenkoStrategy

Source: [`HeyMrRobot/Freqtrade-Adaptive-Renko-Strategy`](https://github.com/HeyMrRobot/Freqtrade-Adaptive-Renko-Strategy) · file `AdaptiveRenkoStrategy.py`

## Could not be measured

```
Impossible to load Strategy 'AdaptiveRenkoStrategy'. This class does not exist or contains Python code errors.
```
