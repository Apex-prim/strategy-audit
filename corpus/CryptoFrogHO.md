...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `CryptoFrogHO.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'CryptoFrogHO'. This class does not exist or contains Python code errors.
