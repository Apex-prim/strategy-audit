...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `SupertrendStrategy.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'SupertrendStrategy'. This class does not exist or contains Python code errors.
