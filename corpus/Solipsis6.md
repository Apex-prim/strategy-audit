...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `Solipsis-v2.6.py`

## Could not be measured

```
Impossible to load Strategy 'Solipsis6'. This class does not exist or contains Python code errors.
```
