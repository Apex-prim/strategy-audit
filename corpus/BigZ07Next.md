...
Источник: [`davidzr/freqtrade-strategies`](https://github.com/davidzr/freqtrade-strategies) · файл `BigZ07Next.py`
...
|---|---|---|
| сделок | 456 | 1298 |
| ожидание на сделку | -0.32 | 0.39 |
| p-значение средней | 0.07069 | 0.006011 |
| «купил и держи», % | -59.23 | 346.34 |
| итог стратегии, % | -14.62 | 51.2 |
| Шарп | -1.02 | 0.8 |
| Сортино | -0.76 | 0.4 |
| просадка, % | 23.28 | 16.77 |
| фактор прибыли | 0.73 | 1.36 |

**Осталось от ожидания вне выборки: н/п**

⚠ **В окне автора средняя доходность НЕ ЗНАЧИМА** (p = 0.07069 > 0.05). То есть даже in-sample результат неотличим от нуля.

Базовая линия: «купил и держи» на тех же парах дал **-59.23%**, стратегия — **-14.62%**.
