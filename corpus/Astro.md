...
Source: [`jaredrsommer/freqtradestrategies`](https://github.com/jaredrsommer/freqtradestrategies) · file `Astro.py`

## Could not be measured

```
Impossible to load Strategy 'Astro'. This class does not exist or contains Python code errors.
```
