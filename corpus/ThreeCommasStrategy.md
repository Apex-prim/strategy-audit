...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `ThreeCommasStrategy.py`

## Could not be measured

```
Impossible to load Strategy 'ThreeCommasStrategy'. This class does not exist or contains Python code errors.
```
