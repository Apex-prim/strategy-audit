...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `ThreeCommasStrategy.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'ThreeCommasStrategy'. This class does not exist or contains Python code errors.
