# CopyLitmusMinMaxBroadClassificationStrategy

Source: [`markdregan/FreqAI-Marcos-Lopez-De-Prado`](https://github.com/markdregan/FreqAI-Marcos-Lopez-De-Prado) · file `CopyLitmusMinMaxBroadClassificationStrategy.py`

## Could not be measured

```
Impossible to load Strategy 'CopyLitmusMinMaxBroadClassificationStrategy'. This class does not exist or contains Python code errors.
```
