...
|---|---|---|
| trades | 4081 | 13046 |
| average profit per trade % | -0.36 | -0.19 |
| win rate % | 57.7 | 58.9 |
| average trade duration, minutes | 597.0 | 644.0 |
| duration measured in own candles | 119.4 | 128.8 |
...
**Excess over buy-and-hold** (regime-free): author's window **-27.5 pp**, out of sample **-443.0 pp**.
