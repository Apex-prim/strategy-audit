...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `Solipsis-v2.5.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'Solipsis5'. This class does not exist or contains Python code errors.
