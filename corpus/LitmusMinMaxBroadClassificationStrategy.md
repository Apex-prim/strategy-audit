# LitmusMinMaxBroadClassificationStrategy

Source: [`markdregan/FreqAI-Marcos-Lopez-De-Prado`](https://github.com/markdregan/FreqAI-Marcos-Lopez-De-Prado) · file `LitmusMinMaxBroadClassificationStrategy.py`

## Could not be measured

```
Impossible to load Strategy 'LitmusMinMaxBroadClassificationStrategy'. This class does not exist or contains Python code errors.
```
...
| мёртвые настройки трейлинга | **found** | trailing_stop=False, но trailing_stop_positive=0.198 задан — читается как работающая защита |
