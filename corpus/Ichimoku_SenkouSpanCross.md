...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `Ichimoku_SenkouSpanCross.py`

## Could not be measured

```
Impossible to load Strategy 'Ichimoku_SenkouSpanCross'. This class does not exist or contains Python code errors.
```
