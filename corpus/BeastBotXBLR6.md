...
|---|---|---|
| trades | 116 | 519 |
| average profit per trade % | 1.11 | 1.15 |
| win rate % | 75.9 | 75.9 |
| average trade duration, minutes | 165.0 | 176.0 |
| duration measured in own candles | 33.0 | 35.2 |
...
**Excess over buy-and-hold** (regime-free): author's window **+76.5 pp**, out of sample **-245.0 pp**.
