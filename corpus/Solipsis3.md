...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `Solipsis-v3-fuck (1).py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'Solipsis3'. This class does not exist or contains Python code errors.
