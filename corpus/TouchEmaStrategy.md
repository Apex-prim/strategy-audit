...
|---|---|---|
| trades | 1072 | 4121 |
| average profit per trade % | -0.71 | -0.24 |
| win rate % | 66.0 | 68.5 |
| average trade duration, minutes | 2051.0 | 1831.0 |
| duration measured in own candles | 410.2 | 366.2 |
...
**Excess over buy-and-hold** (regime-free): author's window **-6.9 pp**, out of sample **-423.2 pp**.
