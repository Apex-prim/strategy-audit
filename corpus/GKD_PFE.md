...
|---|---|---|
| trades | 6530 | 10583 |
| average profit per trade % | -0.26 | -0.25 |
| win rate % | 48.7 | 54.3 |
| average trade duration, minutes | 304.0 | 277.0 |
| duration measured in own candles | 5.07 | 4.62 |
...
**Excess over buy-and-hold** (regime-free): author's window **-30.4 pp**, out of sample **-445.3 pp**.
