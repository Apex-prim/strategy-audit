...
|---|---|---|
| trades | 8782 | 12910 |
| average profit per trade % | -0.19 | -0.21 |
| win rate % | 28.1 | 29.4 |
| average trade duration, minutes | 49.0 | 52.0 |
| duration measured in own candles | 9.8 | 10.4 |
...
**Excess over buy-and-hold** (regime-free): author's window **-28.8 pp**, out of sample **-442.9 pp**.
