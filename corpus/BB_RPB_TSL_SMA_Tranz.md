...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `BB_RPB_TSL_SMA_Tranz_1_5_2_MAIN (10).py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'BB_RPB_TSL_SMA_Tranz'. This class does not exist or contains Python code errors.
