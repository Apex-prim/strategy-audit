...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `BB_RPB_TSL_SMA_Tranz_1_5_2_MAIN (10).py`

## Could not be measured

```
Impossible to load Strategy 'BB_RPB_TSL_SMA_Tranz'. This class does not exist or contains Python code errors.
```
