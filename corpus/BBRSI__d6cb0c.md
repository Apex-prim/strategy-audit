...
Source: [`Foxel05/freqtrade-stuff`](https://github.com/Foxel05/freqtrade-stuff) · file `BBRSI.py`

## Could not be measured

```
Impossible to load Strategy 'BBRSI'. This class does not exist or contains Python code errors.
```
