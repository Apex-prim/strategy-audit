...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `BinHV27.py`
...
| p-значение средней | 0.0001062 | 0.007594 |
| «купил и держи», % | -58.23 | 346.34 |
| итог стратегии, % | -39.84 | -73.94 |
| Шарп | -5.15 | -2.04 |
| Сортино | -5.18 | -1.93 |
| просадка, % | 46.73 | 84.17 |
| фактор прибыли | 0.78 | 0.88 |

**Осталось от ожидания вне выборки: отрицательное**

Базовая линия: «купил и держи» на тех же парах дал **-58.23%**, стратегия — **-39.84%**.
...
| прогрев не объявлен | ⚠ НАЙДЕНО | самый длинный индикатор 240 свечей, startup_candle_count не задан (по умолчанию 0) |
