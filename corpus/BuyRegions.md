...
Источник: [`nateemma/strategies`](https://github.com/nateemma/strategies) · файл `BuyRegions.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'BuyRegions'. This class does not exist or contains Python code errors.
