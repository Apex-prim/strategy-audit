...
Source: [`Bananajoexxc/RegimeFilterStrategy-Freqtrade`](https://github.com/Bananajoexxc/RegimeFilterStrategy-Freqtrade) · file `RegimeFilterStrategy.py`
...
| прогрев объявлен | clean | 250 при потребности 200 |
