...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `UpSliceStrategy.py`
...
| прогрев не объявлен | **found** | самый длинный индикатор 9 свечей, startup_candle_count не задан (по умолчанию 0) |
