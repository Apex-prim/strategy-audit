...
|---|---|---|
| trades | 41 | 304 |
| average profit per trade % | 1.16 | 1.43 |
| win rate % | 73.2 | 78.0 |
| average trade duration, minutes | 108.0 | 95.0 |
| duration measured in own candles | 21.6 | 19.0 |
...
**Excess over buy-and-hold** (regime-free): author's window **+64.9 pp**, out of sample **-277.1 pp**.
