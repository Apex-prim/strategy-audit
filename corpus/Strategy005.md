...
Source: [`TheoBrigitte/freqtrade`](https://github.com/TheoBrigitte/freqtrade) · file `Strategy005.py`
...
| win rate % | 79.9 | 83.1 |
| average trade duration, minutes | 2086.0 | 2296.0 |
| duration measured in own candles | 417.2 | 459.2 |
...
**Excess over buy-and-hold** (regime-free): author's window **-4.6 pp**, out of sample **-429.8 pp**.
