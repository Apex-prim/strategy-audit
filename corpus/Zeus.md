...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `Zeus_HO (1).py`

## Could not be measured

```
Impossible to load Strategy 'Zeus'. This class does not exist or contains Python code errors.
```
