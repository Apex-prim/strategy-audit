...
Source: [`jaredrsommer/freqtradestrategies`](https://github.com/jaredrsommer/freqtradestrategies) · file `MKR (3).py`

## Could not be measured

```
Impossible to load Strategy 'MKR'. This class does not exist or contains Python code errors.
```
