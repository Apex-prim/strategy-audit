...
Source: [`jerome-benoit/freqai-strategies`](https://github.com/jerome-benoit/freqai-strategies) · file `QuickAdapterV3.py`

## Could not be measured

```
Impossible to load Strategy 'QuickAdapterV3'. This class does not exist or contains Python code errors.
```
