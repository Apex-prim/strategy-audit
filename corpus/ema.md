...
Source: [`davidzr/freqtrade-strategies`](https://github.com/davidzr/freqtrade-strategies) · file `ema.py`
...
|---|---|---|
| trades | 17783 | 13023 |
| average profit per trade % | -0.15 | -0.2 |
| win rate % | 26.2 | 25.6 |
| average trade duration, minutes | 105.0 | 99.0 |
| duration measured in own candles | 21.0 | 19.8 |
| expectancy per trade (USDT) | -0.05 | -0.07 |
| mean profit p-value | 2.582e-29 | 1.306e-36 |
| market change % (baseline) | -58.23 | 346.34 |
| strategy total % | -96.58 | -96.57 |
| Sharpe | -39.25 | -11.7 |
| Sortino | -68.63 | -15.55 |
| max drawdown % | 96.58 | 96.57 |
| profit factor | 0.7 | 0.6 |
