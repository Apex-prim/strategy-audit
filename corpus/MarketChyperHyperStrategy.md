...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `MarketChyperHyperStrategy.py`

## Could not be measured

```
Impossible to load Strategy 'MarketChyperHyperStrategy'. This class does not exist or contains Python code errors.
```
