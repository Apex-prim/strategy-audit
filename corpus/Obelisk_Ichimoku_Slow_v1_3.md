...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `Obelisk_Ichimoku_Slow_v1_3.py`
...
| прогрев занижен | **found** | объявлено 180, нужно не менее 200 |
