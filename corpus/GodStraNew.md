...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `GodStra.py`

## Could not be measured

```
Impossible to load Strategy 'GodStraNew'. This class does not exist or contains Python code errors.
```
