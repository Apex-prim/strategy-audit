...
|---|---|---|
| trades | 94 | 553 |
| average profit per trade % | 1.31 | 0.16 |
| win rate % | 94.7 | 85.9 |
| average trade duration, minutes | 259.0 | 155.0 |
| duration measured in own candles | 51.8 | 31.0 |
...
**Excess over buy-and-hold** (regime-free): author's window **+74.5 pp**, out of sample **-337.2 pp**.
