...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `TrixV15Strategy.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'TrixV15Strategy'. This class does not exist or contains Python code errors.
