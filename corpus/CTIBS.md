...
```
ПРЕДМЕТ НЕ ТОТ: стратегия объявила 15m, движок считал на 1h
```
...
| indicator recursion (freqtrade's own `recursive-analysis`) | **found** | индикаторы меняются от объёма истории: ema_dif35 -1.284% |
