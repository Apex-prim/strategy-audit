...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `GodStraNew40.py`

## Could not be measured

```
Impossible to load Strategy 'GodStraNew40'. This class does not exist or contains Python code errors.
```
