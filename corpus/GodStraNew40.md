...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `GodStraNew40.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'GodStraNew40'. This class does not exist or contains Python code errors.
