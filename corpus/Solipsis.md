...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `Solipsis-tradedbexp.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'Solipsis'. This class does not exist or contains Python code errors.
