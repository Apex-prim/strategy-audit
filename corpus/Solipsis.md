...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `Solipsis-tradedbexp.py`

## Could not be measured

```
Impossible to load Strategy 'Solipsis'. This class does not exist or contains Python code errors.
```
