...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `SuperTrendPure.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'SuperTrendPure'. This class does not exist or contains Python code errors.
