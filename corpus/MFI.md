...
|---|---|---|
| trades | 6515 | 13751 |
| average profit per trade % | -0.19 | -0.19 |
| win rate % | 55.3 | 56.4 |
| average trade duration, minutes | 253.0 | 254.0 |
| duration measured in own candles | 50.6 | 50.8 |
...
**Excess over buy-and-hold** (regime-free): author's window **-21.1 pp**, out of sample **-442.9 pp**.
