...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `Obelisk_Ichimoku_ZEMA_v1.py`
...
| прогрев объявлен | ✅ ПРОШЛА | 500 при потребности 14 |
