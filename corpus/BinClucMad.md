...
|---|---|---|
| trades | 629 | 1888 |
| average profit per trade % | -0.04 | 0.51 |
| win rate % | 69.3 | 71.8 |
| average trade duration, minutes | 342.0 | 292.0 |
| duration measured in own candles | 68.4 | 58.4 |
...
**Excess over buy-and-hold** (regime-free): author's window **+55.1 pp**, out of sample **-122.9 pp**.
