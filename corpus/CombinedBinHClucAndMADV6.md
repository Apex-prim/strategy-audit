...
|---|---|---|
| trades | 346 | 1270 |
| average profit per trade % | 0.21 | 0.52 |
| win rate % | 79.5 | 79.9 |
| average trade duration, minutes | 136.0 | 142.0 |
| duration measured in own candles | 27.2 | 28.4 |
...
**Excess over buy-and-hold** (regime-free): author's window **+68.4 pp**, out of sample **-222.6 pp**.
