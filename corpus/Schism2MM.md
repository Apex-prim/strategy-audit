...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `Schism2MM.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'Schism2MM'. This class does not exist or contains Python code errors.
