...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `SolipsisMM.py`

## Could not be measured

```
Impossible to load Strategy 'SolipsisMM'. This class does not exist or contains Python code errors.
```
