...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `SolipsisMM.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'SolipsisMM'. This class does not exist or contains Python code errors.
