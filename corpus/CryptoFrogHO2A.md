...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `CryptoFrogHO2A.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'CryptoFrogHO2A'. This class does not exist or contains Python code errors.
