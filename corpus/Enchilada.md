...
Source: [`werkkrew/freqtrade-strategies`](https://github.com/werkkrew/freqtrade-strategies) · file `Enchilada.py`

## Could not be measured

```
Impossible to load Strategy 'Enchilada'. This class does not exist or contains Python code errors.
```
