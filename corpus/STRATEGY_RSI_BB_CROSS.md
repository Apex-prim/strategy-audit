...
|---|---|---|
| trades | 4897 | 11930 |
| average profit per trade % | -0.2 | -0.22 |
| win rate % | 67.9 | 66.0 |
| average trade duration, minutes | 471.0 | 460.0 |
| duration measured in own candles | 94.2 | 92.0 |
...
**Excess over buy-and-hold** (regime-free): author's window **-13.2 pp**, out of sample **-443.0 pp**.
