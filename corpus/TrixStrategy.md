...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `TrixStrategy.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'TrixStrategy'. This class does not exist or contains Python code errors.
