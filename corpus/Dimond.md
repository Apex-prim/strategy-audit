...
Source: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · file `Dimond.py`

## Could not be measured

```
Impossible to load Strategy 'Dimond'. This class does not exist or contains Python code errors.
```
