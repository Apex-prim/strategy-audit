...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `Dimond.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'Dimond'. This class does not exist or contains Python code errors.
