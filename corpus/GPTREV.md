...
Source: [`jaredrsommer/freqtradestrategies`](https://github.com/jaredrsommer/freqtradestrategies) · file `GPTREV.py`

## Could not be measured

```
Impossible to load Strategy 'GPTREV'. This class does not exist or contains Python code errors.
```
