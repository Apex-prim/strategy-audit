...
Источник: [`PeetCrypto/freqtrade-stuff`](https://github.com/PeetCrypto/freqtrade-stuff) · файл `mabStra.py`

## Результат

**НЕ ПРИМЕНИМА** — Impossible to load Strategy 'mabStra'. This class does not exist or contains Python code errors.
